...
You can generate the passwords in the **Passwords** tab. The password for each contestant will be different from each other. You can re-generate all passwords or individual passwords.
